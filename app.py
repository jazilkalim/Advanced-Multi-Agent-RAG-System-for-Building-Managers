...
# Fix for PyTorch/Streamlit conflict - MUST be at the very top before any other imports
...
# Import Streamlit after setting environment variable
import streamlit as st
import base64

# Set page config
st.set_page_config(page_title="Building Manager's Assistant")
...
try:
    ...
    st.markdown(f"""
        ...
        .stChatMessage, .stMarkdown, .stTextArea, .stTextInput {{
    ...
    st.warning("Background image 'background2.jpg' not found. Using default background.")

st.title("📚 Building Manager's Assistant")
st.subheader("Ask anything relevant to Building Manager job and guide. \n  Creator: jazil@uchicago.edu")
...
if user_input := st.chat_input("Type your question..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            try:
                response = rag_output(user_input)
